...
class Incubator_i_Instance_dt_dtp_pkf(Node):   # Rename class as appropriate
  ...
  def handle_device_state(self, msg: DeviceStatei):
     ...
     self.get_logger().info(f"t_heater: {t_heater}, prediction_error: {prediction_error}, average_temperature: {average_temperature}")
     ...
     kPredMsg.average_temperature.value.data = T
