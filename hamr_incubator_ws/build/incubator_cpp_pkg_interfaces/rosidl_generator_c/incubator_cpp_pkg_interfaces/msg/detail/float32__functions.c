...
incubator_cpp_pkg_interfaces__msg__Float32__create()
{
  ...
  incubator_cpp_pkg_interfaces__msg__Float32 * msg = (incubator_cpp_pkg_interfaces__msg__Float32 *)allocator.allocate(sizeof(incubator_cpp_pkg_interfaces__msg__Float32), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(incubator_cpp_pkg_interfaces__msg__Float32));
  bool success = incubator_cpp_pkg_interfaces__msg__Float32__init(msg);
  if (!success) {
...
incubator_cpp_pkg_interfaces__msg__Float32__destroy(incubator_cpp_pkg_interfaces__msg__Float32 * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    incubator_cpp_pkg_interfaces__msg__Float32__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
incubator_cpp_pkg_interfaces__msg__Float32__Sequence__init(incubator_cpp_pkg_interfaces__msg__Float32__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  incubator_cpp_pkg_interfaces__msg__Float32 * data = NULL;

  if (size) {
    data = (incubator_cpp_pkg_interfaces__msg__Float32 *)allocator.zero_allocate(size, sizeof(incubator_cpp_pkg_interfaces__msg__Float32), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = incubator_cpp_pkg_interfaces__msg__Float32__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        incubator_cpp_pkg_interfaces__msg__Float32__fini(&data[i - 1]);
      }
...
incubator_cpp_pkg_interfaces__msg__Float32__Sequence__fini(incubator_cpp_pkg_interfaces__msg__Float32__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      incubator_cpp_pkg_interfaces__msg__Float32__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  incubator_cpp_pkg_interfaces__msg__Float32__Sequence * array = (incubator_cpp_pkg_interfaces__msg__Float32__Sequence *)allocator.allocate(sizeof(incubator_cpp_pkg_interfaces__msg__Float32__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = incubator_cpp_pkg_interfaces__msg__Float32__Sequence__init(array, size);
  if (!success) {
...
incubator_cpp_pkg_interfaces__msg__Float32__Sequence__destroy(incubator_cpp_pkg_interfaces__msg__Float32__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    incubator_cpp_pkg_interfaces__msg__Float32__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
incubator_cpp_pkg_interfaces__msg__Float32__Sequence__are_equal(const incubator_cpp_pkg_interfaces__msg__Float32__Sequence * lhs, const incubator_cpp_pkg_interfaces__msg__Float32__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!incubator_cpp_pkg_interfaces__msg__Float32__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  incubator_cpp_pkg_interfaces__msg__Float32__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(incubator_cpp_pkg_interfaces__msg__Float32);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    incubator_cpp_pkg_interfaces__msg__Float32 * data =
      (incubator_cpp_pkg_interfaces__msg__Float32 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!incubator_cpp_pkg_interfaces__msg__Float32__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          incubator_cpp_pkg_interfaces__msg__Float32__fini(&output->data[i]);
        }
        return false;
      }
    }
