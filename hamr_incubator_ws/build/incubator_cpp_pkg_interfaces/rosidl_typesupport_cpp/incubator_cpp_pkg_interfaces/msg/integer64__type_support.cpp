...
static const _Integer64_type_support_symbol_names_t _Integer64_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, incubator_cpp_pkg_interfaces, msg, Integer64)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, incubator_cpp_pkg_interfaces, msg, Integer64)),
  }
};
...
{
  return &::incubator_cpp_pkg_interfaces::msg::rosidl_typesupport_cpp::Integer64_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, incubator_cpp_pkg_interfaces, msg, Integer64)() {
  return get_message_type_support_handle<incubator_cpp_pkg_interfaces::msg::Integer64>();
}
