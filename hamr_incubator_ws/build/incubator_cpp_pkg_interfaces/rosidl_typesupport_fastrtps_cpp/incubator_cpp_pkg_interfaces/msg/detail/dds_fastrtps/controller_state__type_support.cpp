...
#include "incubator_cpp_pkg_interfaces/msg/detail/controller_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const incubator_cpp_pkg_interfaces::msg::ControllerState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  incubator_cpp_pkg_interfaces::msg::ControllerState & ros_message)
{
  // Member: controller_state
  cdr >> ros_message.controller_state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = incubator_cpp_pkg_interfaces::msg::ControllerState;
    is_plain =
      (
      offsetof(DataType, controller_state) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const incubator_cpp_pkg_interfaces::msg::ControllerState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<incubator_cpp_pkg_interfaces::msg::ControllerState *>(
    untyped_ros_message);
...
{
  return &incubator_cpp_pkg_interfaces::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, incubator_cpp_pkg_interfaces, msg, ControllerState)() {
  return &incubator_cpp_pkg_interfaces::msg::typesupport_fastrtps_cpp::_ControllerState__handle;
}
