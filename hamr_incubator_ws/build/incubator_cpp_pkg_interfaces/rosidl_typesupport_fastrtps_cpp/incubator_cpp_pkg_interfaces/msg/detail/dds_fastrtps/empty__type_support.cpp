...
#include "incubator_cpp_pkg_interfaces/msg/detail/empty__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const incubator_cpp_pkg_interfaces::msg::Empty & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  incubator_cpp_pkg_interfaces::msg::Empty & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = incubator_cpp_pkg_interfaces::msg::Empty;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const incubator_cpp_pkg_interfaces::msg::Empty *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<incubator_cpp_pkg_interfaces::msg::Empty *>(
    untyped_ros_message);
...
get_message_type_support_handle<incubator_cpp_pkg_interfaces::msg::Empty>()
{
  return &incubator_cpp_pkg_interfaces::msg::typesupport_fastrtps_cpp::_Empty__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, incubator_cpp_pkg_interfaces, msg, Empty)() {
  return &incubator_cpp_pkg_interfaces::msg::typesupport_fastrtps_cpp::_Empty__handle;
}
