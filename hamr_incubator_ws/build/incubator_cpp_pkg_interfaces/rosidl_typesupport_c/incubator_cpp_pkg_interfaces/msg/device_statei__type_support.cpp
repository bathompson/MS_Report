...
static const _DeviceStatei_type_support_symbol_names_t _DeviceStatei_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, incubator_cpp_pkg_interfaces, msg, DeviceStatei)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, incubator_cpp_pkg_interfaces, msg, DeviceStatei)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, incubator_cpp_pkg_interfaces, msg, DeviceStatei)() {
  return &::incubator_cpp_pkg_interfaces::msg::rosidl_typesupport_c::DeviceStatei_message_type_support_handle;
}
