...
{
  new (message_memory) incubator_cpp_pkg_interfaces::msg::Float32(_init);
}

void Float32_fini_function(void * message_memory)
{
  auto typed_message = static_cast<incubator_cpp_pkg_interfaces::msg::Float32 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Float32_message_member_array[1] = {
  {
    ...
    offsetof(incubator_cpp_pkg_interfaces::msg::Float32, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Float32_message_members = {
  ...
  1,  // number of fields
  sizeof(incubator_cpp_pkg_interfaces::msg::Float32),
...
{
  return &::incubator_cpp_pkg_interfaces::msg::rosidl_typesupport_introspection_cpp::Float32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, incubator_cpp_pkg_interfaces, msg, Float32)() {
  return &::incubator_cpp_pkg_interfaces::msg::rosidl_typesupport_introspection_cpp::Float32_message_type_support_handle;
}
