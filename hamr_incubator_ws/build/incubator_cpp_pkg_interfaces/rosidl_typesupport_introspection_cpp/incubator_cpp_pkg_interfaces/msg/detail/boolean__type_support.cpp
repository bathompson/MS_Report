...
{
  new (message_memory) incubator_cpp_pkg_interfaces::msg::Boolean(_init);
}

void Boolean_fini_function(void * message_memory)
{
  auto typed_message = static_cast<incubator_cpp_pkg_interfaces::msg::Boolean *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Boolean_message_member_array[1] = {
  {
    ...
    offsetof(incubator_cpp_pkg_interfaces::msg::Boolean, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Boolean_message_members = {
  ...
  1,  // number of fields
  sizeof(incubator_cpp_pkg_interfaces::msg::Boolean),
...
{
  return &::incubator_cpp_pkg_interfaces::msg::rosidl_typesupport_introspection_cpp::Boolean_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, incubator_cpp_pkg_interfaces, msg, Boolean)() {
  return &::incubator_cpp_pkg_interfaces::msg::rosidl_typesupport_introspection_cpp::Boolean_message_type_support_handle;
}
