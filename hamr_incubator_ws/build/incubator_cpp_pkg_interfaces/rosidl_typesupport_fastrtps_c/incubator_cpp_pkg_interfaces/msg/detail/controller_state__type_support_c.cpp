...
#include "incubator_cpp_pkg_interfaces/msg/detail/controller_state__rosidl_typesupport_fastrtps_c.h"
...
using _ControllerState__ros_msg_type = incubator_cpp_pkg_interfaces__msg__ControllerState;
...
static uint32_t _ControllerState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_incubator_cpp_pkg_interfaces__msg__ControllerState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = incubator_cpp_pkg_interfaces__msg__ControllerState;
    is_plain =
      (
...
static size_t _ControllerState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_incubator_cpp_pkg_interfaces__msg__ControllerState(
